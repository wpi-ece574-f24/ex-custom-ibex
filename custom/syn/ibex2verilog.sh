...
export LR_SYNTH_OUT_DIR="verilog"
...
for file in ../rtl/*.sv ../../rtl/system/*.sv ../../vendor/lowrisc_ibex/rtl/*.sv; do
  module=$(basename -s .sv "$file")
  ...
  sv2v \
    --define=SYNTHESIS --define=YOSYS \
    ../../rtl/system/*_pkg.sv \
    ../../vendor/lowrisc_ibex/rtl/*_pkg.sv \
    ../../vendor/pulp_riscv_dbg/src/*_pkg.sv \
...
rm -f "$LR_SYNTH_OUT_DIR"/generated/ibex_demo_system.v
